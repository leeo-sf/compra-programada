...
public class CalendarioMotorCompraServiceTests
{
    ...
    public async Task Deve_Retornar_SeEhDiaDeCompra_Quando_DeveExecutarCompraHoje_Solicitado(string dataAtual, bool deveExecutarCompraResult)
    {
        // Arrange
    ...
    public async Task Deve_Retornar_ProximaDataCompra_Quando_Solicitado(string dataAtual, string proximaDataCompra)
    {
        // Arrange
        var dateTimeProvaiderFaker = new DateTimeProvaiderFaker(DateTime.Parse(dataAtual));
        var sut = new CalendarioMotorCompraService(_config, dateTimeProvaiderFaker);
    ...
    public async Task Deve_Retornar_DataReferenciaExecucao_Quando_Solicitado(string dataAtual, string dataExecutada, string dataReferencia)
    {
        // Arrange
        var dateTimeProvaiderFaker = new DateTimeProvaiderFaker(DateTime.Parse(dataAtual));
        var sut = new CalendarioMotorCompraService(_config, dateTimeProvaiderFaker);
    ...
    public async Task Deve_Retornar_SeEhDiaUtil_Quando_Solicitado(string data, bool ehDiaUtil)
    {
        // Arrange
    ...
    public async Task Deve_Retornar_ProximoDiaUtil_Quando_Solicitado(string data, string proximoDiaUtil)
    {
        // Arrange
        var sut = new CalendarioMotorCompraService(_config);
