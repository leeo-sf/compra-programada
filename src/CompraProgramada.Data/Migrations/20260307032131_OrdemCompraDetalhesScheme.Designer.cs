...
namespace CompraProgramada.Data.Migrations
{
    ...
    [Migration("20260307032131_OrdemCompraDetalhesScheme")]
    partial class OrdemCompraDetalhesScheme
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompraProgramada.Domain.Entity.EvolucaoCarteira", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("evolucao_carteira", (string)null);
                });

            modelBuilder.Entity("CompraProgramada.Domain.Entity.HistoricoCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("Valor")
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("valor")
                        .HasComment("valor compra");

                    b.HasKey("Id");

                    b.HasIndex("ContaGraficaId");

                    b.ToTable("historico_compra", (string)null);
                });
            ...
            modelBuilder.Entity("CompraProgramada.Domain.Entity.OrdemCompra", b =>
                {
                    ...
                    b.Property<decimal>("PrecoUnitario")
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("preco_unitatio")
                        .HasComment("preço de fechamento de cada ativo");
                    ...
                    b.Property<int>("QuantidadeTotal")
                        ...
                        .HasComment("quantos total de ativos");
                    ...
                    b.Property<decimal>("ValorTotal")
                        ...
                        .HasComment("valor total da ordem de compra");
            ...
            modelBuilder.Entity("CompraProgramada.Domain.Entity.OrdemCompraDetalhe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("OrdemCompraId")
                        .HasColumnType("int")
                        .HasColumnName("ordem_compra_id")
                        .HasComment("identificador ordem compra");
                    ...
                    b.Property<string>("Tipo")
                        ...
                        .HasColumnType("longtext")
                        .HasColumnName("tipo")
                        .HasComment("tipo do lote");

                    b.HasKey("Id");

                    b.HasIndex("OrdemCompraId");

                    b.ToTable("ordem_compra_detalhe", (string)null);
                });
            ...
            modelBuilder.Entity("CompraProgramada.Domain.Entity.ContaGrafica", b =>
                {
                    ...
                    b.Navigation("EvolucaoCarteira");

                    b.Navigation("HistoricoComprar");
                });
