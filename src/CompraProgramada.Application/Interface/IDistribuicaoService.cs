...
{
    Task<(List<AtivoAhCompraDto>, List<FechamentoAtivoB3Dto>)> DistribuirGrupoAtivoAsync(List<ClienteDto> clientesAtivos, decimal totalConsolidado, DateTime dataExeucao, CancellationToken cancellationToken);
